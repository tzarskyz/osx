...
* Installs Homebrew[http://mxcl.github.com/homebrew] and related formulas for development.
* Downloads and installs software packages generally not in the {App Store}[http://www.apple.com/macosx/whats-new/app-store.html]:
  ...
  *x OmniFocus[http://www.omnigroup.com/applications/omnifocus]
  *x OmniOutliner[http://www.omnigroup.com/applications/omnioutliner]
  *x OmniGraffle[http://www.omnigroup.com/applications/omnigraffle]
  * OmniDazzle[http://www.omnigroup.com/products/omnidazzle]
  * ExpanDrive[http://www.expandrive.com]
  * {iStat Menus}[http://bjango.com/apps/istatmenus]
  *x {Air Display}[http://avatron.com/apps/air-display]
  * {Pastebot Sync}[http://tapbots.com/software/pastebot/#sync]
  * GitHub[http://mac.github.com]
  * Snippets[http://www.snippetsapp.com]
  * Espresso[http://macrabbit.com/espresso]
  * CodeKit[http://incident57.com/codekit]
  *x Acorn[http://flyingmeat.com/acorn]
  * DoubleTake[http://echoone.com/doubletake]
  * ImageOptim[http://imageoptim.pornel.net]
  * ImageAlpha[http://pornel.net/imagealpha]
  * VLC[http://www.videolan.org/vlc]
  * pgAdmin[http://www.pgadmin.org/index.php]
  *x {VMWare Fusion}[http://www.vmware.com/products/fusion]
  *x Billings[http://www.billingsapp.com]
...
Edit any of the *.sh files in the scripts folder to your liking and then run setup.sh to execute them all.
...
Feel free to delete this osx project directory after completing installation.
...
* Configure iCal.
* Configure iTunes.
* Install the Network Link Conditioner preference pane (found via /Developer/Applications/Utilities/Network Link Conditioner/)
* Install {Firefox Extensions}[http://www.aeonscope.net/software/applications/firefox].
...
* {Mathias Bynens' OSX Defaults}[https://github.com/mathiasbynens/dotfiles/blob/master/.osx]

= Contributions

Please log all feedback/issues via {GitHub Issues}[https://github.com/bkuhlmann/osx/issues]. Thanks.
