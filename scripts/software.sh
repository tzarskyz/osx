...
# SETTINGS
export RUBY_VERSION=1.9.3-p286
...
export DROPBOX_FILE=Dropbox%201.4.12.dmg
...
export FIREFOX_FILE=Firefox%2013.0.1.dmg
...
export OMNIFOCUS_URL=http://www.omnigroup.com/ftp1/pub/software/MacOSX/10.6
export OMNIFOCUS_FILE=OmniFocus-1.10.3.dmg
export OMNIOUTLINER_URL=http://downloads.omnigroup.com/software/MacOSX/10.4
export OMNIOUTLINER_FILE=OmniOutliner-3.10.5.dmg
export OMNIGRAFFLE_URL=http://downloads.omnigroup.com/software/MacOSX/10.5
export OMNIGRAFFLE_FILE=OmniGrafflePro-5.4.dmg
...
export ISTATS_FILE=istatmenus3.24.zip
...
export SKYPE_FILE=Skype_6.0.60.2946.dmg
