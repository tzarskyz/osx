...
export OMNIFOCUS_APP_NAME=OmniFocus
...
export OMNIOUTLINER_APP_NAME=OmniOutliner
...
export OMNIGRAFFLE_APP_NAME="OmniGraffle Professional 5"
...
export OMNIDAZZLE_APP_NAME=OmniDazzle
...
export EXPANDRIVE_APP_NAME=ExpanDrive
...
export INDUCTION_APP_NAME=Induction
...
export DELICIOUS_LIBRARY_APP_NAME="Delicious Library 2"
